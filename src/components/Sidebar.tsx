...
import { ClearAllRounded, BarChartRounded } from '@mui/icons-material';

const Sidebar = () => {
    return (
        <div className="md:w-1/6 w-px-100 h-screen shadow-2xl">
            <div className=" border-b py-3 mt-1 flex justify-around ">
                <p className="text-xl  font-semibold">Service Labs</p>
            </div>
